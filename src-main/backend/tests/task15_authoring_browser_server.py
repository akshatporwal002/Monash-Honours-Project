"""Isolated synthetic educator fixture for the circuit authoring browser journey."""
...
SCRATCH = ROOT / ".tmp-task15" / os.environ.get("TASK15_AUTHORING_RUN", "authoring")
SCRATCH.mkdir(parents=True, exist_ok=True)
os.environ.update(
    DATABASE_URL=f"sqlite:///{(SCRATCH / 'authoring.db').as_posix()}",
    APP_ENV="development",
    FRONTEND_ORIGIN="http://localhost:5241",
...
def main():
    ...
    uvicorn.run(create_app(), host="127.0.0.1", port=8141)
