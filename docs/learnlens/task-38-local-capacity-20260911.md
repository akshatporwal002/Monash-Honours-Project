...
Latest campaign `8c8b5d5` was **rejected and reverted**: 35/50 journeys reached
human assessment, 14 requests timed out and one simulation was interrupted.
The retained application code is equivalent to `67b6c92`, whose clean campaign
reached 45/50. Both failed the ordinary/formative targets; all eleven campaigns
remain preserved below and in the machine-readable receipt.
...
## Rejected task-view admission — clean 8c8b5d5 campaign
