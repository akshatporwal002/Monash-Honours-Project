...
Regression evidence, run from `src-main/backend` with Python 3.11 and isolated temporary databases:
...
- Related queue/fencing coverage: **46 passed, 1 deselected**, 30.03 seconds.
  The killed-process/backup scenario was outside this focused run; it remains included in the full suite. Ruff passes on all four changed Python files.
...
All provider faults are synthetic. The [integration verification](next-wave-integration-verification-2026-09-10.md) records later complete-suite results.
